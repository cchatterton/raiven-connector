...
The administrator console provides automatic model selection and response settings, private saved conversations and optional memory from your own previous sessions. New installations start with memory disabled. Existing POC installations retain their memory behaviour and saved data.
...
Live generation verified with the service default and qwen3.8-flash-next-nvfp4. Some advertised models have no active endpoint. The console always uses the service default, ignoring previously saved model IDs.
